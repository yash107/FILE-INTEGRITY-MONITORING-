...
baselines = r"C:\Users\admin\Desktop\Baselines"  #Baseline.txt will be at this specified path
secure_path = ""
...
def CheckIntegrity(dir,number):
    ...
    if dir=="":
        ...
        fc.configure(text=fc._text+ '\n'.join(files_changed))
        fa.configure(text=fa._text+ '\n'.join(files_added))
        fr.configure(text=fr._text+ '\n'.join(files_removed))
...
#Some Variables
font_data = ("Raleway",18)
label_text_clr = "#000000"
btn_fg_clr = "#27ab55"
btn_text_clr = "#000000"
...
root = ctk.CTk()
root.title("  Integrologist - A File Integrity Monitor")
...
label1.place(relx=0.40, y=40,anchor=tk.CENTER)#absolute placing
